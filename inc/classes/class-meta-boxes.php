...
class Meta_Boxes {
    ...
    public function add_custom_meta_box() {
        ...
        foreach ( $screens as $screen ) {
            add_meta_box(
                ...
                __('Hide Page Title', 'omnixima'),      // Box title
    ...
    ?>
        ...
        <select name="hide_page_title" id="hide_page_title" class="postbox">
            <option value=""><?php esc_html_e( 'Select', 'omnixima' )?></option>
            <option value="yes" <?php selected( $value, 'yes' ); ?>><?php esc_html_e( 'Yes', 'omnixima' )?></option>
            <option value="no" <?php selected( $value, 'no' ); ?>><?php esc_html_e( 'No', 'omnixima' )?></option>
        </select>
    <?php
    }
